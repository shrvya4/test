...
exports.manualResearchFetch = exports.fetchWeeklyResearch = void 0;
...
async function fetchPapers(condition, daysBack = 7) {
    try {
        ...
        const papers = data.resultList.result.map((paper) => {
            var _a, _b, _c;
            return ({
                id: paper.id,
                ...
                doi: paper.doi,
                url: (_c = (_b = (_a = paper.fullTextUrlList) === null || _a === void 0 ? void 0 : _a.fullTextUrl) === null || _b === void 0 ? void 0 : _b[0]) === null || _c === void 0 ? void 0 : _c.url
            });
        });
...
exports.fetchWeeklyResearch = functions.pubsub
    ...
    try {
        ...
        if (weeklySummary.length > 0) {
            ...
            weeklySummary.forEach(summary => {
                ...
                batch.set(docRef, Object.assign(Object.assign({}, summary), { lastUpdated: admin.firestore.FieldValue.serverTimestamp() }));
            });
            ...
            batch.set(overallSummaryRef, {
                ...
                totalPapers: weeklySummary.reduce((sum, s) => sum + s.totalCount, 0),
...
exports.manualResearchFetch = functions.https.onRequest(async (req, res) => {
    try {
        ...
        res.json({
            ...
            message: `Found ${weeklySummary.reduce((sum, s) => sum + s.totalCount, 0)} new papers`
        });
    }
    catch (error) {
